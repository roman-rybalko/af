...
chmod a-w etc/rc.d/advancedfiltering_smtp_exim advancedfiltering/smtp/exim/configure advancedfiltering/smtp/exim/message_loop_detector.pl \
	advancedfiltering/smtp/exim/mid_list_encoder.pl
