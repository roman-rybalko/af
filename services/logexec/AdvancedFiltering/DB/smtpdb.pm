...
sub delete_message
{
	...
	delete_ldap_object($_) foreach reverse find_ldap_value("afUSMTPMessageId=$mid,afUServiceName=smtpdb+afUServiceRealm=$realm,ou=user,o=advancedfiltering", { objectClass => '*' }, 'dn');
	return 0;
}
